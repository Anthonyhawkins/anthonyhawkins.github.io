...
|---|---|---|
| Algebra 2 | Khan Academy | 3Blue1Brown - Essence of Calculus, for intuition |
| Trigonometry | Khan Academy | Satellite look-angle worked examples |
| Pre-Calculus | Khan Academy or Stewart Precalculus | Parametric curves and vectors |
| Calculus I-II | Stewart, *Calculus: Early Transcendentals* | 3Blue1Brown - Essence of Calculus |
| Calculus III | Stewart + Curtis, *Orbital Mechanics for Engineering Students* | 3Blue1Brown - Essence of Linear Algebra |
| Linear Algebra | Strang + MIT OCW 18.06 | Eigen matrix/vector exercises |
| Probability | Devore, *Probability and Statistics for Engineering* | Monte Carlo link simulations |
| Graph Theory | CLRS Ch. 22-26 + Rosen discrete math | NetworkX and Boost.Graph examples |
...
- Build system: CMake
- Libraries: Eigen, Boost.Graph/Asio, nlohmann/json, grpc++, cpp-httplib or Crow
- Testing: Google Test
...
- Python 3.11+
- Libraries: NumPy, SciPy, Matplotlib, Skyfield, Astropy, NetworkX, Plotly
- Optional: PuLP or OR-Tools for optimization
- pytest for testable analysis notebooks/scripts

### Setup Exercise

1. Build a C++ CMake project that prints "Starlink Network Toolkit".
2. Build a Python environment that imports NumPy, Skyfield, and NetworkX.
3. Parse one public TLE and plot a simple satellite altitude/visibility result.
